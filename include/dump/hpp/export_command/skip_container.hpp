...
namespace cpp_dump
{
    ...
    namespace _detail
    {
        ...
        private:
            const std::function<std::size_t(
                std::size_t, const std::function<std::size_t()>&)>& _skip_size_func;
            const std::function<std::size_t()>& _orig_size_func;
            std::size_t _index;
            bool _done;

            std::size_t calc_skip_size() const noexcept
            {
                return _skip_size_func(_index, _orig_size_func);
            }
        };
        ...
        skip_iterator(It&&,
                      const std::function<std::size_t(
                          std::size_t, const std::function<std::size_t()>&)>&,
                      const std::function<std::size_t()>&) -> skip_iterator<It>;
        ...
        public:
            ...
            {
                return skip_iterator(
                    iterable_begin(_original), _skip_size_func, _orig_size_func);
            }
            auto end() const noexcept
            {
                return skip_iterator(
                    iterable_end(_original), _skip_size_func, _orig_size_func);
            }
