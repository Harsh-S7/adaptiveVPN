...
namespace cpp_dump
{
    ...
    namespace _detail
    {
        ...
        inline std::string export_arithmetic(bool value,
                                             const std::string&,
                                             std::size_t,
                                             std::size_t,
                                             bool,
        ...
        inline std::string export_arithmetic(char value,
                                             const std::string&,
                                             std::size_t,
                                             std::size_t,
                                             bool,
        ...
        unsigned int _get_max_digits(unsigned int base)
        {
            ...
            constexpr UnsignedT T_max = std::max<UnsignedT>(
        ...
        template<typename T>
        inline auto export_arithmetic(T value,
                                      const std::string&,
                                      std::size_t,
                                      std::size_t,
                                      bool,
            ...
            -> std::enable_if_t<is_arithmetic<T> && std::is_integral_v<T>, std::string>
        {
            ...
            auto [base,
                  ...
                  chunk,
                  space_fill,
                  make_unsigned_or_no_space_for_minus] = int_style_.value();
            ...
            bool add_space_for_minus =
                std::is_signed_v<T> && !make_unsigned_or_no_space_for_minus;
            ...
            using UnsignedTOrInt =
                std::conditional_t<std::is_same_v<UnsignedT, unsigned char>,
                                   unsigned int,
                                   UnsignedT>;
            ...
            {
                output.reserve(digits > 0 ? digits + (chunk == 0 && add_space_for_minus)
                                          : sizeof(T) * 8 + 1);
            ...
            bool added_minus_before_fill =
                space_fill && (digits == 0 || output.length() < digits);
            ...
            if (chunk > 0)
            {
                ...
                new_output.reserve(output.size() + (output.size() - 1) / chunk
                                   + add_space_for_minus);
        ...
        template<typename T>
        inline auto export_arithmetic(const T& value,
                                      const std::string&,
                                      std::size_t,
                                      std::size_t,
                                      bool,
