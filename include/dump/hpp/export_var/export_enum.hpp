...
\
            template<> \
            inline std::string export_enum(const TYPE& enum_const, \
                                           const std::string&, \
                                           std::size_t, \
                                           std::size_t, \
                                           bool, \
            ...
            { \
                static std::map<TYPE, std::string> enum_to_string { \
                    _p_CPP_DUMP_EXPAND_VA(_p_CPP_DUMP_EXPAND_FOR_EXPORT_ENUM, \
                                          __VA_ARGS__)}; \
...
namespace cpp_dump
{
    ...
    namespace _detail
    {
        ...
        template<typename T>
        inline std::string export_enum(const T&,
                                       const std::string&,
                                       std::size_t,
                                       std::size_t,
                                       bool,
...
CPP_DUMP_DEFINE_EXPORT_ENUM(cpp_dump::es_style_t,
                            cpp_dump::es_style_t::no_es,
                            cpp_dump::es_style_t::original,
                            cpp_dump::es_style_t::by_syntax);
CPP_DUMP_DEFINE_EXPORT_ENUM(cpp_dump::cont_indent_style_t,
