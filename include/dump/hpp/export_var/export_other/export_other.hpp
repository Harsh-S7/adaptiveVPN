...
namespace cpp_dump
{
    ...
    namespace _detail
    {
        ...
        template<typename T>
        inline auto export_other(const T& optional,
        ...
        {
            return export_optional(optional,
                                   indent,
                                   last_line_length,
                                   current_depth,
                                   fail_on_newline,
        ...
        template<typename T>
        inline auto export_other(const T& type_info,
                                 const std::string& indent,
                                 std::size_t last_line_length,
                                 std::size_t current_depth,
                                 bool fail_on_newline,
        ...
        {
            return export_type_info(type_info,
                                    indent,
                                    last_line_length,
                                    current_depth,
                                    fail_on_newline,
        ...
        namespace es
        {
            ...
            {
                return es_style == es_style_t::original ? es::identifier(s)
                                                        : es::number(s);
            }
        ...
        inline std::string export_other(const std::bitset<N>& bitset,
                                        const std::string&,
                                        std::size_t,
                                        std::size_t,
                                        bool,
                                        const export_command&)
        {
            ...
            if (pos > 0)
                output.append(bitset_str, 0, pos);
        ...
        template<typename T>
        inline std::string export_other(const std::complex<T>& complex,
                                        const std::string&,
                                        std::size_t,
                                        std::size_t current_depth,
                                        bool,
                                        const export_command&)
        {
            ...
            return es::_complex_component(std::to_string(std::real(complex))) + " "
                ...
                + es::number(std::to_string(std::abs(complex))) + es::op(", ")
                + es::member("arg") + es::op("/") + es::member("pi") + es::op("= ")
                + es::number(std::to_string(std::arg(complex) / pi))
        ...
        template<typename... Args>
        inline std::string export_other(const std::variant<Args...>& variant,
                                        const std::string& indent,
                                        std::size_t last_line_length,
                                        std::size_t current_depth,
                                        bool fail_on_newline,
        ...
        inline std::string export_other(const es_value_t& esv,
                                        const std::string& indent,
                                        std::size_t last_line_length,
                                        std::size_t current_depth,
                                        bool fail_on_newline,
                                        const export_command& command)
        {
            return export_es_value_t(
                esv, indent, last_line_length, current_depth, fail_on_newline, command);
        }

        template<typename T>
        inline auto export_other(const T& value,
                                 const std::string& indent,
                                 std::size_t last_line_length,
                                 std::size_t current_depth,
                                 bool fail_on_newline,
        ...
        {
            return export_other_object(value,
                                       indent,
                                       last_line_length,
                                       current_depth,
                                       fail_on_newline,
