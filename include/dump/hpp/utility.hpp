...
namespace cpp_dump
{
    ...
    namespace _detail
    {
        ...
        inline bool has_newline(std::string_view s)
        {
            return s.find("\n") != std::string::npos;
        }
        ...
        inline std::size_t get_length(std::string_view s)
        {
            ...
            auto begin         = s.begin();
            decltype(begin) end;
            while ((end = std::search(
                        begin, s.end(), es_begin_token.begin(), es_begin_token.end()))
                   != s.end())
            {
                length += end - begin;
        ...
        inline std::size_t get_last_line_length(std::string_view s,
        ...
        inline std::string replace_string(std::string_view s,
                                          ...
                                          std::string_view replace)
        {
            ...
            auto begin = s.begin();
            decltype(begin) end;
            while ((end = std::search(begin, s.end(), search.begin(), search.end()))
                   != s.end())
            {
